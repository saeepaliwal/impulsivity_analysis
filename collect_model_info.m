function collect_model_info(analysis_name, subject_type,stats,PAPER)
...
% Save parameters
save (['../results/' sprintf('%s', analysis_name) '/parameter_workspace_' sprintf('%d',subject_type)],'omega_all','theta_all','beta_all','binFEgrid','labels');
else
