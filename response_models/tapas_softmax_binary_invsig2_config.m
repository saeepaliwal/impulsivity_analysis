function c = tapas_softmax_binary_sig2_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_softmax_binary_invsig2';
...
% Model filehandle
c.obs_fun = @tapas_softmax_binary_invsig2;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @tapas_softmax_binary_invsig2_transp;
